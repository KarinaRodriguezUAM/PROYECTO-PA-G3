    ...
    IConfiguration configuration) : Controller
{
    ...
    public async Task<IActionResult> GetAll(CancellationToken cancellationToken)
    {
        ...
        var endpoint =
            $"{configuration["ApiSettings:BaseUrl"]}/api/Roles/GetAllRoles";
        ...
        var apiResult =
            JsonSerializer.Deserialize<ApiResponse<List<RoleDto>>>(
                content,
                JsonOptions);
        ...
        CancellationToken cancellationToken)
    {
        ...
        var endpoint =
            $"{configuration["ApiSettings:BaseUrl"]}/api/Roles/GetRoleById/{id}";
        ...
        CancellationToken cancellationToken)
    {
        ...
        var endpoint =
            $"{configuration["ApiSettings:BaseUrl"]}/api/Roles/CreateRole";
        ...
        CancellationToken cancellationToken)
    {
        ...
        var endpoint =
            $"{configuration["ApiSettings:BaseUrl"]}/api/Roles/UpdateRole/{id}";
        ...
        CancellationToken cancellationToken)
    {
        ...
        var endpoint =
            $"{configuration["ApiSettings:BaseUrl"]}/api/Roles/DeleteRole/{id}";
